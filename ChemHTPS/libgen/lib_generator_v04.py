...
_SCRIPT_VERSION = "v0.1.4"
_REVISION_DATE = "8/03/2015"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d',"--data_file", action='store', dest='file_name', default='building_blocks.dat', help="provide the building block data file. Default is building_blocks.dat file.")
    ...
    for i,line in enumerate(infile):
        ...
        ## check if smiles
        if smiles.isspace() or len(smiles)==0:
            continue
